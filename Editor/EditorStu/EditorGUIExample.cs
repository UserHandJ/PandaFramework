...
public class EditorGUIExample : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        #region 1 文本控件、层级标签控件、颜色获取控件
        //文本控件
        EditorGUILayout.LabelField("编辑器路径：Editor/EditorStu/EditorMemo");
        ...
        EditorGUILayout.EndFoldoutHeaderGroup();//结束折叠
        #endregion
